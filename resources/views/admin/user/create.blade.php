                ...
                <div class="form-group row">
                  ...
                  <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-lg-8 col-md-12">
                      <input value="" type="text" class="form-control" id="input-ten-dang-nhap" placeholder="Tên đăng nhập" oninput="changeData('ten-dang-nhap')" />
                  ...
                  <div class="border-top">
                    <div class="card-body">
                      <button id="create-user" type="button" class="btn btn-primary" onclick="create()">
                        Thêm mới
                      </button>
                    </div>
                  </div>
